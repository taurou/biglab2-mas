...
function NavigationBar(props) {
    ...
    return (
        <Navbar className = "justify-content-between fixed-top" bg="success">
        <Navbar.Brand href="/">
          ...
          <span id="todo">ToDo Manager</span>
        </Navbar.Brand>
        {props.loggedIn ? <>  <Form inline><FormControl type="text" placeholder="Search" className="mr-sm-2" /></Form></> : ""}
        
        <span>{props.loggedIn ? <><Button variant="outline-light" onClick={props.doLogOut}>Logout</Button><span>   </span></> : ""}  
